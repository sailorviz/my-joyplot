...
export function triggerDrawPopularityDensityOfAllSongs(popContext, kdeContextFromStep1, language) {
  ...
  // 计算密度曲线
  // const kdeOfAllSongs = addPopularitiesKDEForAllSongs(timelineSvg, yScale, legend, axisX);
